                ...
                return (
                  ...
                  >
                    {isEditing ? (
                      ...
                      <>
                        <div
                          // break-words: whitespace-pre-wrap keeps your line
                          // breaks but only wraps at spaces, so pasting a
                          // URL or an id with none in it made the bubble
                          // wider than the column it sits in.
                          className="max-w-[85%] whitespace-pre-wrap break-words rounded-2xl
                                      rounded-br-md bg-[var(--hover)] px-4 py-2.5 font-sans
